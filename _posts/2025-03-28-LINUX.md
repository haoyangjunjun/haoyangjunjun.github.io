...
author:     "hangyangjun"
header-img: "img\Linux-centos.jpg"
tags:
    - 笔记
    - Linux
	- 学习
...
`ll *.txt`   
![Alt text](img\Linux\image-1.png)
![Alt text](img\Linux\image-2.png)
...
## 正则表达式
![Alt text](img\Linux\image-3.png)
### `[]`定义集合：
...
![Alt text](img\Linux\image-4.png)
**`grep`需使用`-E`选项**
...
### 输入重定向
使用 "<"符来修改标准输入设备  
![Alt text](img\Linux\image-5.png)
...
### 标准输出重定向、标准错误重定向
使用 ">"符或者">>"来修改输出设备  
![Alt text](img\Linux\image-6.png)
...
![[img\Pasted image 20241225203913.png]]  
