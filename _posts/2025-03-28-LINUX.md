...
subtitle:   "上学期(2024)课余时间整理的笔记，也用于练习md语法"
...
格式：  `chattr`  `[参数]`  `文件`。  
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image.png)
例：给test.txt添加只读属性  
`chattr +i test.txt`   
...
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-2.png)
...
## 正则表达式
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-3.png)
### `[]`定义集合：
...
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-4.png)  
**`grep`需使用`-E`选项**
...
### 输入重定向
使用 "<"符来修改标准输入设备  
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-5.png)
...
### 标准输出重定向、标准错误重定向
使用 ">"符或者">>"来修改输出设备  
![Alt text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-6.png)
...
![text](https://github.com/haoyangjunjun/haoyangjunjun.github.io/blob/master/img/linux/image-7.png)
## pstree命令
格式：`pstree [选项]`  
